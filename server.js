...
mongoose.connect("mongodb+srv://nautilus:NHpFLBN3CadMY8p@csn291.oohtxhp.mongodb.net/csn291?retryWrites=true&w=majority");
...
app.post("/login", passport.authenticate("local", {
	successRedirect: "/signup",//write the page to be rendered here
...
app.post("/signup", function (req, res) {
	...
	User.register(new User({ username: username, name: name, emailID: emailID }),
